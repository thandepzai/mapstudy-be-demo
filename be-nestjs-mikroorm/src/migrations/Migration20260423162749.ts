...
export class Migration20260423162749 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`create table "user" ("id" uuid not null, "full_name" varchar(255) not null, "username" varchar(255) not null, "password" varchar(255) not null, "email" varchar(255) not null, "phone" varchar(255) not null, "gender" int not null, "birth_year" int not null, "facebook_link" varchar(255) null, "province" varchar(255) not null, "school" varchar(255) not null, "refresh_token" varchar(255) null, "created_at" timestamptz not null, constraint "user_pkey" primary key ("id"));`);
